...
namespace Pokatun.API.Migrations
{
    ...
    [Migration("20210222204049_RemoveRedundantIndex")]
    partial class RemoveRedundantIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pokatun.API.Entities.Bid", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Pokatun.API.Entities.Bid", b =>
                {
                    b.HasOne("Pokatun.API.Entities.HotelNumber", "HotelNumber")
                        .WithMany("Bids")
                        .HasForeignKey("HotelNumberId")
