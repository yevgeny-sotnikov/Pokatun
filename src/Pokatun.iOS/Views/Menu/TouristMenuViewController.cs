...
namespace Pokatun.iOS.Views.Menu
{
    ...
    public partial class TouristMenuViewController : BaseViewController<TouristMenuViewModel>
    {
        private TitlePhotoView _titlePhotoView;

        public TouristMenuViewController() : base(nameof(TouristMenuViewController), null)
        {
        }
